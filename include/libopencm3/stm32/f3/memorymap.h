...
/* PERIPH_BASE_APB1 + 0x7C00 (0x4000 7C00 - 0x4000 97FF): Reserved */
#define DAC2_BASE			(PERIPH_BASE_APB1 + 0x9800)
#define TIM18_BASE			(PERIPH_BASE_APB1 + 0x9C00)
...
#define TIM19_BASE			(PERIPH_BASE_APB2 + 0x5C00)
...
/* PERIPH_BASE_APB2 + 0x0800 (0x4001 2800 - 0x4001 2BFF): Reserved */
